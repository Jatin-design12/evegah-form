  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8 space-y-6">
        ...
        {/* SEARCH + FILTER */}
        <div className="bg-white border rounded-xl shadow p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <input
            className="w-full sm:w-96 border rounded-xl px-4 py-2"
        ...
        <div className="bg-white border rounded-xl shadow overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Rider</th>
                ...
                <th className="px-4 py-3 text-left font-semibold text-gray-700">E-Bike ID</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Battery ID</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Start</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Expected Return</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Returned At</th>
                ...
                <th className="px-4 py-3 text-left font-semibold text-gray-700">Rental ID</th>
              </tr>
            </thead>
